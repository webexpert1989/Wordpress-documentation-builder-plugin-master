...
(function($){
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		toHierarchy: function(options){
			...
			function _recursiveItems(item){
				...
				if (id){
					...
					/****************************************************
					 * it is worked while item have data-id attribute 
					 * Updated: 1/26/2016
					 ***************************************************/
					if($(item).data("id")){
						var currentItem = {
							id: $(item).data("id"),
							label: $(item).children("div").text(),
						};
						if ($(item).children(o.listType).children(o.items).length > 0){
							currentItem.children = [];
							$(item).children(o.listType).children(o.items).each(function(){
		...
		_isAllowed: function(parentItem, level, levels){
			...
			/****************************************************
			 * Fixed height problem of placeholder while drag list item
			 * Updated: 1/29/2016
			 ***************************************************/
			if(this.placeholder.height() < 10){
				this.placeholder.height($(this.currentItem).height());
			}
			/////////////////////////////////////////////////////
